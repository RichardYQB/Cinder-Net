...
def call_judge(prompt, answer, api_key, model="deepseek-chat"):#deepseek快思考模型
...
if __name__ == "__main__":
    ...
    # 训练参数
    parser.add_argument("--save_dir", type=str, default="../out_grpo/exp_2")
    ...
    parser.add_argument("--grad_clip", type=float, default=0.2)#梯度裁剪防止梯度爆炸，设置太大不稳定
    ...
    # 路径
    parser.add_argument("--data_path", type=str, default="/root/autodl-tmp/Cinder-Net/benchmark/mini_bench/GRPO_train.jsonl")
    parser.add_argument("--tokenizer_path", type=str, default="../tokenizer_15k")
    parser.add_argument("--sft_model_path", type=str, 
                       default="/root/autodl-tmp/Cinder-Net/thinking_distill_768.pth")
    
    # GRPO 参数
    parser.add_argument("--num_generations", type=int, default=4)
    parser.add_argument("--beta", type=float, default=0.05)
    parser.add_argument("--judge_api_key", type=str, default='sk-ea73df1472334fc28126029fcdc5841b')
    ...
    parser.add_argument("--swanlab_project", type=str, default="Cinder-Net-GRPO")
    ...
    if args.use_swanlab and is_main_process():
        import swanlab
        swanlab.login(api_key="YQxoyC8TAQxLEeKR7ltpS")
